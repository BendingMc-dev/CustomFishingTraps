...
public class AdventureUtil {
    ...
    // Added my AdventureUtil class here which handles all player interactive messages and titles
    ...
    public static void consoleMessage(String s) {
        Audience au = CustomFishingTraps.adventure.sender(Bukkit.getConsoleSender());
    ...
    public static void playerMessage(Player player, String s) {
        Audience au = CustomFishingTraps.adventure.player(player);
        MiniMessage mm = MiniMessage.miniMessage();
        Component parsed = mm.deserialize(replaceLegacy(s));
        au.sendMessage(parsed);
    }
